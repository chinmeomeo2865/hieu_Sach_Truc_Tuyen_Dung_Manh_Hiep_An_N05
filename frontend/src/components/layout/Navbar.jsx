            ...
            <div className="flex items-center gap-1 justify-end">
              ...
              {user && user.role && user.role !== 'customer' && (
                <Link
                  ...
                  title={user.role === 'admin' ? 'Trang quản trị' : user.role === 'product_manager' ? 'Trang quản lý' : 'Trang thủ kho'}
                  className="w-9 h-9 rounded-lg flex items-center justify-center text-muted hover:text-ink hover:bg-surface-subtle transition-colors shrink-0"
                >
                  <svg className="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
